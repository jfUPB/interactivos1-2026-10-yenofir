...
```
**BridgeServer ajustado:**
Se agrego una línea para leer el nuevo Adaptador: `const MicrobitV2Adapter = require("./adapters/MicrobitV2Adapter");`

También se agrego un if en el `createAdapter` para el protocolo nuevo `$T:|X:|Y:|A:|B:|CHK:`
...
if (DEVICE === "microbitv2") {
    ...
    // Pasamos las mismas configuraciones que al adaptador anterior:
    // path (puerto serial), baud (velocidad) y verbose (modo debug)
